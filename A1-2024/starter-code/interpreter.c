...
{
    //printf("Sending lines to script\n");
    ...
    //printf("script: %d, frame: %d, frameStore[frameIdx].linesUsed: %d\n", script_num, frameIdx, frameStore[frameIdx].linesUsed);
